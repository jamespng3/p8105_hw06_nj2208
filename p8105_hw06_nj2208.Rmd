...
I first fitted a linear model using all the possible predictors and then did a shortened version of backward elimination just to get a prelim model to work with.
