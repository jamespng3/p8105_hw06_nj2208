...
<img src="p8105_hw06_nj2208_files/figure-gfm/unnamed-chunk-6-1.png" width="90%" />
...
```
    ...
    ## file path:          C:\Users\CII Equipment\AppData\Local\rnoaa\rnoaa\Cache/ghcnd/USW00094728.dly
...
<img src="p8105_hw06_nj2208_files/figure-gfm/unnamed-chunk-8-1.png" width="90%" />

The estimates for \(\hat\beta_1\) is rather consistent around 1 but the
estimates for \(\hat\beta_0\) deviates between 6-8
...
The 95% confidence interval for \(Log(B_0*B_1)\) is
(2.0124337,2.0137379) and the 95% confidence interval for \(r^2\) is
(0.9108164,0.9112931)
